    ...
    <div className='bg-[#1B1D1F] text-white h-[30vh] flex justify-center items-center'>
      <div className=' bg-[#282B30] border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative'>
            ...
            <div className=' relative my-4'>
                <input type="email" name="" id="" className='block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer' placeholder=''/>
            ...
            <div className=' relative my-4'>
                <input type="password" name="" id="" className='block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer' placeholder=''/>
            ...
            <div className=' relative my-4'>
                <input type="password" name="" id="" className='block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer' placeholder=''/>
                <label htmlFor="" className=' absolute text-sm text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6'>Fonfirmar Contraseña</label>
            ...
            <div>
                <span className='m-4'>Ya tienes una cuenta <Link className=' text-blue-500' to={'/login'}>Iniciar sesion</Link></span>
            </div>
            </form>
        </div>
    </div>
