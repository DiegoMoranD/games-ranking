  ...
  return (
    <div className='bg-[#1B1D1F] text-white h-[30vh] flex justify-center items-center'>
      <div className=' bg-[#282B30] border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative'>
            ...
            <div className=' relative my-4'>
                <input type="email" value={email} onChange={(e)=>setEmail(e.target.value)} required className='block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer' placeholder=''/>
            ...
            <div className=' relative my-4'>
                <input type="password" value={password} onChange={(e)=>setPassword(e.target.value)} required className='block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer' placeholder=''/>
                ...
                <button onClick={submitRegistro} className='w-full mb-4 text-[18px] mt-6 rounded-full bg-white text-emerald-800 hover:bg-emerald-600 hover:text-white py-2 transition-colors duration-300 font-semibold'>Registrarse</button>  

            <div>
                <span className='m-4'>Ya tienes una cuenta <a className='text-blue-500 hover:text-cyan-400 cursor-pointer' href={'/login'}>Iniciar sesion</a></span>
            </div>
            </form>
        </div>
    </div>
